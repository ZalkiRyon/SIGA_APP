...
// Placeholder component - using Settings_new.jsx instead
...
export default function AdminSettings() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#fff' }}>
      <Sidebar role="admin" onLogout={logout} />      <main style={{ flex: 1, padding: '2.5rem 3rem', color: '#222' }}>
